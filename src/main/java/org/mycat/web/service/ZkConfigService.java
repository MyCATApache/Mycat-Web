...
public class ZkConfigService  extends BaseService {
    ...
    private RainbowContext zkConnectOK(RainbowContext context){
		...
		Menu monitorMenuSub1= new Menu("2-1","mycat性能监控","page/monitor/jrdsMycat.html",MENU_TYPE_NODE);
		...
		Menu monitorMenuSub4= new Menu("2-4","mycatJVM性能监控","page/monitor/jrdsjvm.html",MENU_TYPE_NODE);
