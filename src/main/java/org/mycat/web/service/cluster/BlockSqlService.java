...
import org.mycat.web.model.cluster.BlockSql;
...
@Lazy
@Service("blockSqlService")
public class BlockSqlService extends AbstractConfigSevice {
	
	private Class<BlockSql> clazz = BlockSql.class;
	private String menuPath = Constant.MYCAT_CLUSTER_KEY;
	private String zkPath = Constant.CLUSTER_BLOCKSQLS;
