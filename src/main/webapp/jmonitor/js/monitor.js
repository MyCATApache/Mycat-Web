var app = "";
var msgUrl = "/jmsg";
var gcUrl = "../jm/doGC.do";
var hdUrl = "../jm/doHeapDump.do";
var thUrl = "../jm/dumpThead.do";
var sendUrl = "../jm/sendMessage.do"
var clsUrl = "../jm/loadCluster.do";
var dlUrl = "../jm/deadlockCheck.do";
var mtUrl = "../jm/loadMonitorData.do";
var rtUrl = "../jm/loadRuntimeInfo.do";
var ldThUrl = "../jm/loadThreadInfo.do";
...
function buildNav(readerId) {
	var name = {
		'实时监控' : './jmonitor/index.html',
		'系统参数' : './jmonitor/runtime.html',
		'线程信息' : './jmonitor/thread.html',
		'LinuxSSH' : './jmonitor/shell.html'
	};
