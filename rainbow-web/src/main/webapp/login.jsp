...
<div align="center" style="margin-top:50px;height:100%;width:100%">
 <table  border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td><img src="./ui/style/images/login/login_01.gif" width="360" height="130"></td>
      <td><img src="./ui/style/images/login/login_02.gif" width="309" height="130"></td>
      <td><img src="./ui/style/images/login/login_03.gif" width="355" height="130"></td>
    </tr>
    <tr>
      <td><img src="./ui/style/images/login/login_04.gif" width="360" height="255"></td>
      <td><img src="./ui/style/images/login/login_05.gif" width="309" height="255"></td>
      <td align="left" valign="top" width="355" height="255" background="./ui/style/images/login/login_06.gif" style="padding:0px;margin:0px;">
      <div style="height:140px;"></div>
      <table width="355" border="0" cellpadding="2" cellspacing="0">
      	<tr>
          <td>&nbsp;</td>
...
<!--          	<td align="left" valign="middle"></td> -->
         	<td colspan="2" align="left" valign="middle"><input type=image src="./ui/style/images/login/login_btn.png" width="85" height="36"><a href="javascript:location.reload();" style="text-decoration: none;"><img src="./ui/style/images/login/cancel_btn.png" width="85" height="36" border="0"></a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
    	<td><img src="./ui/style/images/login/login_07.gif" width="360" height="183"></td>
    	<td><img src="./ui/style/images/login/login_08.gif" width="309" height="183"></td>
    	<td><img src="./ui/style/images/login/login_09.gif" width="355" height="183"></td>
    </tr>
    <tr>
    	<td colspan="3">
    		<div align="center"  style="position:relative:20px;line-height:20px;"><span style="font-family:arial;">MyCat支持mysql、oracle、sqlserver</span></div>
    	</td>
    </tr>
   </tbody>
 </table>
